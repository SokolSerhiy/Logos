app.controller("countryController", function($scope, $http, $httpParamSerializer, countryUrl){
    ...
    $scope.refresh = function () {
        $http.get(countryUrl+buildParams()).then(function (result) {
    ...
    $scope.create = function (item) {
        $http.post(countryUrl, angular.toJson(item)).then(function (result) {
            $scope.currentView = "table";
        });
    }
    $scope.update = function (item) {
        $http({
            url: countryUrl+"/" + item.id,
            method: "PUT",
