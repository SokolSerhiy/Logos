app.controller("ingredientController", function($scope, $http, $httpParamSerializer, indredientUrl){
    ...
    $scope.refresh = function () {
        $http.get(indredientUrl+buildParams()).then(function (result) {
    ...
    $scope.create = function (item) {
        $http.post(indredientUrl, angular.toJson(item)).then(function (result) {
            $scope.currentView = "table";
        });
    }
    $scope.update = function (item) {
        $http({
            url: indredientUrl+"/" + item.id,
            method: "PUT",
