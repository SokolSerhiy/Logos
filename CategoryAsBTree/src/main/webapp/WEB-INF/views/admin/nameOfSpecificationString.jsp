...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form modelAttribute="filter" action="/admin/noss" method="get" class="form-inline">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/noss" method="POST" modelAttribute="noss">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="noss">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/noss/update/${noss.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/noss/delete/${noss.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
