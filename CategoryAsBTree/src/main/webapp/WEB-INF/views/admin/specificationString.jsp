...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form modelAttribute="filter" action="/admin/ss" method="get" class="form-inline">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/ss" method="POST" modelAttribute="ss">
					<custom:hiddenInputs excludeParams="name, nameOfSpecificationString"/>
					<div class="form-group">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="specString">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/ss/update/${specString.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/ss/delete/${specString.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
