...
@Entity
@Table(name = "name_of_specification_digital", indexes=@Index(columnList = "_name"))
public class NameOfSpecificationDigital {
	...
	@Transient
	private List<MeasuringSystem> ms = new ArrayList<>();
	
	public List<MeasuringSystem> getMs() {
		return ms;
	}
	public void setMs(List<MeasuringSystem> ms) {
		this.ms = ms;
	}
	public int getId() {
		return id;
