...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
					...
					<div class="form-group">
  					...
  					<div class="form-group">
    					<div class="col-sm-offset-2 col-sm-10">
      						...
      						<a class="btn btn-primary" href="/admin/country/cancel<custom:allParams/>">Cancel</a>
    					</div>
  					</div>
				</form:form>
			</div>
		...
		<div class="row">
			...
			<c:forEach items="${countrys.content}" var="country">
				<div class="row">
	...
	<div class="col-md-2 col-xs-12">
		<div class="row">
			...
			<div class="col-md-6 col-xs-6 text-center">
				<custom:size posibleSizes="1,2,5,10" size="${countrys.size}" />
			</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-12 col-xs-12 text-center">
		<custom:pageable page="${countrys}" cell="<li></li>" container="<ul class='pagination'></ul>" />
	</div>
</div>
</div>
</body>
