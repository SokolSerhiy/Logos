...
public class NameOfSpecificationDigitalSpecification implements Specification<NameOfSpecificationDigital>{

	private final BasicFilter filter;

	public NameOfSpecificationDigitalSpecification(BasicFilter filter) {
		this.filter = filter;
	}
