...
<div class="container">
		<div class="row">
			<div class="row">
				<div class="col-sm-12">
					<form class="form-horizontal" action="/apartment" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select  name="rentTypeId" id="rt" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select  name="streetId" id="street" class="form-control">
